...
<body>
<?php 
include('modals/md_registrarInforme.php');
...
<?php
  ...
  ?>
    ...
    <div class='col-xs-6'>  
      <h3> Informes del proyecto <?php echo $row['nombre'] ?></h3>
    </div>
    <div class='col-xs-6'>
      <h3 class='text-right'>   
        <button type="button" class="btn btn-tema btn-sm" data-toggle="modal" data-target="#registroInforme" >
          Agregar Informe
          </button>
      </h3>
    </div>  
    ...
    <div class="col-xs-12">
    <div id="loadInforme" class="text-center"> <img src="loader.gif"></div>
 ...
 <script>
  ...
  <script>
    function load(page){
        ...
        $.ajax({
            url:'consulta/cargarInformeEj.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loadInforme").html("<img src='../imagenes/loader.gif'>");
            },
