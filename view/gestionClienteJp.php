...
<body>
<?php 
include('modals/md_registrarCliente.php');
include('modals/md_modificarCliente.php');
include('modals/md_eliminarCliente.php')
?>
...
<div id="wrapper">
    ...
    <div class='col-xs-6'>
      <h3 class='text-right'>   
        <button type="button" class="btn btn-tema btn-sm" data-toggle="modal" data-target="#registroCliente" >
            Nuevo Cliente
          </button>
      </h3>
    </div>  
    ...
    <div class="col-xs-12">
    <div id="loadCliente" class="text-center"> <img src="loader.gif"></div>
