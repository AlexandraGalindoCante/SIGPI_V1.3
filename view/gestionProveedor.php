...
<body>
<?php
include('modals/md_registrarProveedor.php');
include('modals/md_modificarProveedor.php');
include('modals/md_eliminarProveedor.php')
?>
    ...
    <div class='col-xs-6'>
      <h3 class='text-right'>   
        <button type="button" class="btn btn-tema btn-sm" data-toggle="modal" data-target="#registroProveedor" >
            Agregar proveedor
          </button>
      </h3>
    </div>  
    ...
    <div class="col-xs-12">
    <div id="loadProveedor" class="text-center"> <img src="loader.gif"></div>
...
<script>
  function load(page){
      ...
      $("#loadProveedor").fadeIn('slow');
      $.ajax({
          url:'consulta/cargarProveedor.php',
          data: parametros,
           beforeSend: function(objeto){
          $("#loadProveedor").html("<img src='../imagenes/loader.gif'>");
          },
