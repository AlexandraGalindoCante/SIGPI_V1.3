...
include('modals/md_eliminarEquipo.php')
?>
  ...
  ?>
    ...
    <div class='col-xs-6'>  
      <h3> Equipo del proyecto <?php echo $row['nombre'] ?></h3>
    </div>
    <div class='col-xs-6'>
      <h3 class='text-right'>   
        <button type="button" class="btn btn-tema btn-sm" data-toggle="modal" data-target="#registroEquipo" data-id=" <?php echo $_SESSION['idProyecto'] ?>">
            Agregar integrante
          </button>
      </h3>
    </div>  
    ...
    <div class="col-xs-12">
    <div id="loadEquipo" class="text-center"> <img src="loader.gif"></div>
 ...
 <script>
    function load(page){
        ...
        $("#loadEquipo").fadeIn('slow');
        $.ajax({
            url:'consulta/cargarEquipo.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loadEquipo").html("<img src='../imagenes/loader.gif'>");
            },
