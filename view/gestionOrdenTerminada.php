...
?>
 ...
 <div class='col-xs-6'>  
    ...
    <div class="col-xs-12">
    <div id="loadTerminada" class="text-center"> <img src="loader.gif"></div>
...
<script>
    function load(page){
        ...
        $("#loadTerminada").fadeIn('slow');
        $.ajax({
            url:'consulta/cargarTerminada.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loadTerminada").html("<img src='../imagenes/loader.gif'>");
            },
