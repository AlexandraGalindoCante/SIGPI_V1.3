...
?>
 ...
 <div class='col-xs-6'>  
    ...
    <div class="col-xs-12">
    <div id="loadTramite" class="text-center"> <img src="loader.gif"></div>
...
<script>
    function load(page){
        ...
        $("#loadTramite").fadeIn('slow');
        $.ajax({
            url:'consulta/cargarTramite.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loadTramite").html("<img src='../imagenes/loader.gif'>");
            },
